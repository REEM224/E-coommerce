...
SECRET_KEY = 'django-insecure-1!a$m8bzp!#tg=ze_j-vf--sipvh50o635*+d9ob-z*8n5mr4l'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',#chenge to mysql
        'NAME': 'ecommerce',#name of database
        'USER': 'root',#username of database
        'PASSWORD': 'Reem123321',#password of database
